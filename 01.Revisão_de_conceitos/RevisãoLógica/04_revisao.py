...
def troca(lista,pos1,pos2):
  ...
  position1 = lista[pos1]
  position2 = lista[pos2]
  lista[pos1] = position2
  lista[pos2] = position1
...
def quebra_em_dois(lista,divisor):
    ...
    for x in lista:
        if x < divisor:
            tempArray1 = [x]
            menores = menores + tempArray1
        if x >= divisor:
            tempArray2 = [x]
            maiores = maiores + tempArray2
...
def merge(lista1,lista2):
    ...
    for value in range(0,count):
        ...
        i2 = [lista2[value]]
        if i1 > i2:
          finalArray = finalArray + i2 + i1
        if i2 > i1:
          finalArray = finalArray + i1 +i2
